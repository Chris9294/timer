import { COLORS_PER_ROW, patternColors } from "../data/patternColors";
  ...
  return (
    <section className="pattern-grid" aria-label="Motifs restants du timer">
      {Array.from({ length: totalItems }).map((_, index) => {
        ...
        const columnIndex = index % COLORS_PER_ROW;
        const color = patternColors[columnIndex];
        ...
        return (
          ...
          >
            <PatternComponent color={color} size={96} />
          </div>
        );
      })}
    </section>
